...
var memberList = [
  {
    id: 100001,
    name: "Trần Văn Tài",
    address: "KTX Đại học Bách khoa Hà Nội",
    working: "Học tại Đại học Bách Khoa Hà Nội",
    ...
    backGroundImgSrc:
      "https://baoquangngai.vn/file/8a10a0d36ccebc89016ce0c6fa3e1b83/dataimages/202201/original/images2432117_1.jpg",
    latitude: 21.0052564,
    longitude: 105.8443105,
  },
  {
    id: 100002,
    name: "Trần Đình Đoàn",
    ...
    backGroundImgSrc:
      "https://scontent.fhan4-1.fna.fbcdn.net/v/t1.18169-9/15665760_349445222079960_3463365202288272323_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=300f58&_nc_eui2=AeEsm2uNpnByIjVdz_T24YwXz9x4lqH578DP3HiWofnvwJ6rZiHTAOkp8gOl9kJy4QLe33xcEohRQ0MCQMHIGKqO&_nc_ohc=TCIOOPWXaJUAX8CDgE0&_nc_ht=scontent.fhan4-1.fna&oh=00_AfAtejV8ErkFY0McsvHraUHJzhpU5hW2VK7LjqE2pmDTog&oe=65EE90DD",
    latitude: 17.465619,
    longitude: 106.594883,
  },
  {
    name: "Ông: Trần Hữu Loan 2",
    dateOfBirth: "2024-02-11",
...
function openForm(id) {
  ...
  for (let i = 0; i < memberList.length; i++) {
    if (memberList[i].id == id) {
      memberDetail = memberList[i];
    }
  }

  // Lấy phần tử img bằng cách sử dụng id
  var name = document.getElementById("profile-name");
  name.innerHTML = memberDetail.name;

  var dateOfBirth = document.getElementById("profile-date-of-birth");
  dateOfBirth.innerHTML = memberDetail.dateOfBirth;

  var working = document.getElementById("profile-work");
  working.innerHTML = memberDetail.working;

  var address = document.getElementById("profile-address");
  address.innerHTML = "Địa chỉ: " + memberDetail.address;
  address.href =
    "https://www.google.com/maps?q=" +
    memberDetail.latitude +
    "," +
    memberDetail.longitude;

  var avatarImg = document.getElementById("profile-img");
  avatarImg.src = memberDetail.avatarImgSrc;

  var backGroundImg = document.getElementById("profile-background-img");
  backGroundImg.src = memberDetail.backGroundImgSrc;
